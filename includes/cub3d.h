...
int					check_obstacle_blocks(float new_player_x,
						float new_player_y, t_player *player);
...
int					set_texture_direction(char **texture_char,
						mlx_texture_t **texture, char *value);
